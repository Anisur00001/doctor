...
export const specializations = [
  ...
  "Ophthalmologist",
   ...
   export const testimonials = [
    ...
    export const faqs = [
    {
      question: "How much does a doctor visit with BeyungCare+ cost?",
      answer: "With insurance, you pay your copay based on your plan. We accept most plans, including Medicare. Without insurance, online doctor visits are $129. You can become a BeyungCare+ member and pay $44/visit. Membership is $55 for three months and $180 for a yearly membership."
    },
    {
    ...
    {
      question: "What conditions can BeyungCare+ doctors treat?",
  ...
  {
    icon: Mail,
    text: "support@beyungcare-plus.com",
  },
  {
    icon: MapPin,
...
{ name: "twitter", icon: Twitter, url: "https://twitter.com/beyungcare-plus" },
{ name: "facebook", icon: Facebook, url: "https://facebook.com/beyungcare-plus" },
{ name: "linkedin", icon: Linkedin, url: "https://linkedin.com/company/beyungcare-plus" },
{ name: "instagram", icon: Instagram, url: "https://instagram.com/beyungcare-plus"},
]
